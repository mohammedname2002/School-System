                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="font-icon" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{   route('Promotions.index') }}">{{  trans('main_trans.promotion_students') }}</a> </li>

                        </ul>
                    </li>
                    <!-- menu font icon-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#font-s">
                        ...
                        <ul id="font-s" class="collapse" data-parent="#sidebarnav">
                    ...
                    <!-- menu font icon-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#font-ss">
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">{{trans('main_trans.Parents')}} </span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="font-ss" class="collapse" data-parent="#sidebarnav">
