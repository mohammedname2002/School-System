...
use Livewire\WithFileUploads; //لازم تضيفها بالاول
   ...
   public $show_table = true;
        ...
        try {
            ...
            if (!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    $photo->storeAs("National_ID_Father".$this->National_ID_Father, $photo->getClientOriginalName(), $disk = 'parent_attachments');
    ...
    public function submitForm_edit(){
        ...
        if ($this->Parent_id){
            ...
            $parent->update([
// لازم اكملللللللللللللل باقي الاعمدة  .......................................
